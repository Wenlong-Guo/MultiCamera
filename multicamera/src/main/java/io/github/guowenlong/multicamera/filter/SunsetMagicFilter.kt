 ...
 */
class SunsetMagicFilter (private val context: Context) : BaseFilter() {
    ...
    private var mToneCurveTexture = intArrayOf(-1)
    private var mToneCurveTextureUniformLocation = 0

    override fun init() {
        clear()
        createProgram(context, "camera_vs.glsl", "sunset_fs.glsl")
        ...
        mMaskGrey1TextureId = OpenGLUtils.loadTexture(context, "sunset/rise_mask1.jpg")
        mMaskGrey2TextureId = OpenGLUtils.loadTexture(context, "sunset/rise_mask2.jpg")
    }
