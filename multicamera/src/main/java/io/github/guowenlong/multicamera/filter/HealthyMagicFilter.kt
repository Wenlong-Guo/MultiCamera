 ...
 */
class HealthyMagicFilter(private val context: Context) : BaseFilter() {
    ...
    override fun init() {
        clear()
        createProgram(context, "camera_vs.glsl", "healthy_fs.glsl")
        ...
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(glProgram, "mask")
        ...
        mMaskGrey1TextureId = OpenGLUtils.loadTexture(context, "healthy/healthy_mask_1.jpg")
    }
