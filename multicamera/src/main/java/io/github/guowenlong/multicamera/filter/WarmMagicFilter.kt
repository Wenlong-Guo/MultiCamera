 ...
 */
class WarmMagicFilter(private val context: Context) : BaseFilter() {
    ...
    override fun init() {
        clear()
        createProgram(context, "camera_vs.glsl", "warm_fs.glsl")
        ...
        initBuffer()
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(glProgram, "layerImage")
        mMaskGrey2UniformLocation = GLES20.glGetUniformLocation(glProgram, "greyFrame")
        ...
        mMaskGrey1TextureId = OpenGLUtils.loadTexture(context, "warm/warm_layer1.jpg")
        mMaskGrey2TextureId = OpenGLUtils.loadTexture(context, "warm/bluevintage_mask1.jpg")
